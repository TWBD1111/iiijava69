...
public class GuessNumber extends JFrame {
	...
	public GuessNumber() {
		...
		JScrollPane jsp = new JScrollPane(log);//超出視窗的滑輪效果
		add(jsp, BorderLayout.CENTER);
		
		setSize(640, 480);
		setVisible(true);
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		input.setFont(new Font(null, Font.BOLD, 18));
		log.setFont(new Font(null, Font.BOLD, 18));
	...
	private String createAnser(int d) {
		int num = 10;
